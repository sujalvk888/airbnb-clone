    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex md:hidden overflow-x-auto snap-x snap-mandatory rounded-xl gap-2 no-scrollbar">
        {listing.images?.map((img, idx) => (
          <img key={idx} src={img.url} alt={`Property ${idx}`} className="h-64 w-full object-cover shrink-0 snap-center" />
        ))}
      </div>
      ...
      <div className="hidden md:grid grid-cols-4 grid-rows-2 gap-2 h-[60vh] rounded-2xl overflow-hidden">
        {listing.images && listing.images.length === 5 && (
          <>
            <img src={listing.images[0].url} alt="Cover" className="col-span-2 row-span-2 w-full h-full object-cover hover:opacity-90 transition cursor-pointer" />
            <img src={listing.images[1].url} alt="Img 1" className="w-full h-full object-cover hover:opacity-90 transition cursor-pointer" />
            <img src={listing.images[2].url} alt="Img 2" className="w-full h-full object-cover hover:opacity-90 transition cursor-pointer" />
            <img src={listing.images[3].url} alt="Img 3" className="w-full h-full object-cover hover:opacity-90 transition cursor-pointer" />
            <img src={listing.images[4].url} alt="Img 4" className="w-full h-full object-cover hover:opacity-90 transition cursor-pointer" />
          </>
        )}
      </div>
